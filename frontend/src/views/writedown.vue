<template>
  <div style="height: 100%">
    <Header @changeHome="changewidth" />
    <Sidebar />
    <div :class="collapsed ? 'mainBlock-collapsed' : 'mainBlock'">
      <div class="datePickerZone">
        <div style="padding: 50px; font-size: 30px; color: #0082c3">
